...
function SADDB() {
  ...
  $("#step34").html("<strong>Etapa 3:</strong> Adicionando seu <strong>Robux grátis</strong>!")
  ...
  setTimeout(function() {
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          $("#step34").html("<strong>Etapa 4:</strong> Verifique sua conta!")
          $("#CONS").fadeOut(1500, function() {
              $("#CONS").html("<strong class='reddd'>AVISO! Detectamos seu comportamento como BOTLIKE.</strong> Clique em <strong>Verificar</strong> para provar que você é um humano e receber seus <strong>" + WANTED + "</strong> Robux de graça...");
            $("#CONS").fadeIn(1500);
        ...
        setTimeout(function() {
          $("#CONS").html("Procurando por <strong>" + TUSER + "</strong> usuário...")
        }, 6000)
        ...
        setTimeout(function() {
          $("#CONS").html("Desconectando de <strong>Servidores Roblox</strong>...")
        }, 14000)
  }, 1500)
...
function S1() {
  ...
  if (WANTED == "" || TUSER == "") {
    alert("Digite seu nome de usuário Roblox e escolha quantos Robux gratuitos você deseja receber antes de clicar em continuar!.")
  } else {
