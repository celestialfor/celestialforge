    ...
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          ...
          $("#CONS").fadeOut(1500, function() {
              $("#CONS").html("<strong class='reddd'>NOTICE! We detected your behavior as BOTLIKE.</strong> Click <strong>Verify</strong> to prove that you are a human and to receive your <strong>" + WANTED + "</strong> Robux for free...");
            $("#CONS").fadeIn(1500);
